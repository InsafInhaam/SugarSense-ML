import pandas as pd
import numpy as np
import xgboost as xgb  # ✅ Make sure this import is present
import joblib
...
# Save Model
joblib.dump(model, "models/glucose_prediction_model.pkl")

print("\n✅ Model training complete. Saved as 'models/glucose_prediction_model.pkl'")
